...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse, download and play your retro ROM collection in the browser." },
      { property: "og:title", content: "Arcade Vault — Retro ROM Library" },
      { property: "og:description", content: "Browse, download and play your retro ROM collection in the browser." },
